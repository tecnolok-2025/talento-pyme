// Talento PyME service worker (v7.8.13)
...
importScripts("/config.js?v=7.8.13");

const VERSION = (typeof TP_APP_VERSION !== "undefined") ? TP_APP_VERSION : "7.8.13";

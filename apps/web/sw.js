// Talento PyME service worker (v5.6.6)
...
importScripts("/config.js?v=5.6.6");

const VERSION = (typeof TP_APP_VERSION !== "undefined") ? TP_APP_VERSION : "5.6.6";

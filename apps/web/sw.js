// Talento PyME service worker (v5.7.1)
...
importScripts("/config.js?v=5.7.1");

const VERSION = (typeof TP_APP_VERSION !== "undefined") ? TP_APP_VERSION : "5.7.1";

// Talento PyME service worker (v5.5.12)
...
importScripts("/config.js?v=5.5.12");

const VERSION = (typeof TP_APP_VERSION !== "undefined") ? TP_APP_VERSION : "5.5.12";

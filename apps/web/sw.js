// Talento PyME service worker (v5.5.9)
...
importScripts("/config.js?v=5.5.9");

const VERSION = (typeof TP_APP_VERSION !== "undefined") ? TP_APP_VERSION : "5.5.9";

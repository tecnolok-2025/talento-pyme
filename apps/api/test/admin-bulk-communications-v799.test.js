...
test('v7.9.15 separa comunicaciones a candidatos y empresas', () => {
...
test('v7.9.15 respeta baja de comunicaciones informativas', () => {
...
test('v7.9.15 permite gestionar baja desde respuesta recibida', () => {
...
test('v7.9.15 agrega pie institucional y evita pedir credenciales', () => {
...
test('v7.9.15 registra historial agregado de comunicaciones', () => {

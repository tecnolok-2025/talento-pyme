...
test('v7.9.11 separa comunicaciones a candidatos y empresas', () => {
...
test('v7.9.11 respeta baja de comunicaciones informativas', () => {
...
test('v7.9.11 permite gestionar baja desde respuesta recibida', () => {
...
test('v7.9.11 agrega pie institucional y evita pedir credenciales', () => {
...
test('v7.9.11 registra historial agregado de comunicaciones', () => {

...
test('v7.9.12 separa comunicaciones a candidatos y empresas', () => {
...
test('v7.9.12 respeta baja de comunicaciones informativas', () => {
...
test('v7.9.12 permite gestionar baja desde respuesta recibida', () => {
...
test('v7.9.12 agrega pie institucional y evita pedir credenciales', () => {
...
test('v7.9.12 registra historial agregado de comunicaciones', () => {

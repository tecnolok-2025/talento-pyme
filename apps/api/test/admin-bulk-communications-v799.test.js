...
test('v7.9.16 separa comunicaciones a candidatos y empresas', () => {
...
test('v7.9.16 respeta baja de comunicaciones informativas', () => {
...
test('v7.9.16 permite gestionar baja desde respuesta recibida', () => {
...
test('v7.9.16 agrega pie institucional y evita pedir credenciales', () => {
...
test('v7.9.16 registra historial agregado de comunicaciones', () => {

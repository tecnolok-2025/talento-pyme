...
test('v7.9.10 separa comunicaciones a candidatos y empresas', () => {
...
test('v7.9.10 respeta baja de comunicaciones informativas', () => {
...
test('v7.9.10 permite gestionar baja desde respuesta recibida', () => {
...
test('v7.9.10 agrega pie institucional y evita pedir credenciales', () => {
...
test('v7.9.10 registra historial agregado de comunicaciones', () => {

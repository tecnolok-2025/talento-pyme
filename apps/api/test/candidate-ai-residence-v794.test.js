...
test('v7.9.5 infiere ciudad, provincia y país para localidades argentinas inequívocas',()=>{
...
test('v7.9.5 guarda provincia de residencia y metadatos del análisis profesional',()=>{
...
test('presentación se corrige sólo por acción explícita del candidato y toma todo el relato',()=>{
  ...
  assert.match(candidate,/Resumen profesional elaborado por Talento PyME/);

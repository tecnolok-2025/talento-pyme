...
test('v7.9.13 incorpora pestaña administrativa Reportes con descarga y envío', () => {
...
test('API declara dependencia PDFKit y frontend v7.9.13', () => {
...
test('v7.9.13 usa logos institucionales y flujo PDF anclado al margen izquierdo', () => {
...
test('v7.9.13 contabiliza altas de empresa por la cuenta COMPANY y no por edición del perfil', () => {
...
test('v7.9.13 nombre de archivo comienza con YYMMDD-HHmm para orden cronológico', () => {

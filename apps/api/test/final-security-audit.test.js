...
test('frontend y cache declaran 7.8.13', () => {
  assert.match(config, /TP_APP_VERSION = "7\.8\.13"/);
  assert.match(sw, /service worker \(v7\.8\.13\)/);
  assert.match(sw, /config\.js\?v=7\.8\.13/);
});

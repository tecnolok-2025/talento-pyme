...
test('v7.9.0 elimina pendiente de candidatos y usa aprendiz como integración inicial', () => {
...
test('frontend declara v7.9.0', () => {
  assert.match(config, /TP_APP_VERSION = "7\.9\.0"/);
});
